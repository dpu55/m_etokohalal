...
{	
	...
	$smarty->assign('action_link',  array('text' => $_LANG['x_40'], 'href'=>'menu.php?act=add'));
...
elseif($_REQUEST['act'] == 'edit')
{
	...
	$smarty->assign('action_link',  array('text' => $_LANG['x_39'], 'href'=>'menu.php?act=list'));
...
elseif($_REQUEST['act'] == 'update')
{
	...
	if($num > 0)
	{
		sys_msg($_LANG['x_41'],0,$link);
	}
	else
	{
		sys_msg($_LANG['x_42'],0,$link);
	}
}
elseif($_REQUEST['act'] == 'delete')
{
	...
	if($num > 0)
	{
		sys_msg($_LANG['x_43'],0,$link);
	}
	else
	{
	 	sys_msg($_LANG['x_44'],0,$link);
	}
}
...
elseif($_REQUEST['act'] == 'add_menu')
{
	...
	if($num > 0)
	{
		sys_msg($_LANG['x_46'],0,$link);
	}
	else
	{
		sys_msg($_LANG['x_47'],0,$link);
	}
}
