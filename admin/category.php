...
elseif ($_REQUEST['act'] == 'drop_thumb')
{
    ...
    $link= array(array('text' => $_LANG['x_185'], 'href' => 'category.php?act=edit&cat_id=' . $cat_id), array('text' =>$_LANG['x_186'], 'href' => 'category.php?act=list'));
    sys_msg($_LANG['x_187'], 0, $link);
}
/*------------------------------------------------------ */
//-- 批量转移商品分类页面
/*------------------------------------------------------ */
