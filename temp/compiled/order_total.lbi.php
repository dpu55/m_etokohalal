...
*<?php echo $this->_var['lang']['complete_acquisition']; ?>
    ...
    <?php if ($this->_var['config']['use_integral'] && $this->_var['config']['use_bonus']): ?><br/><?php echo $this->_var['lang']['with_price']; ?><?php endif; ?><?php if ($this->_var['config']['use_bonus']): ?> <?php echo $this->_var['lang']['de']; ?><?php echo $this->_var['lang']['bonus']; ?>: <span class="price"><?php echo $this->_var['total']['will_get_bonus']; ?></span><?php endif; ?><?php endif; ?>
    ...
    + <?php echo $this->_var['lang']['tax']; ?>：<span class="price">pajak <?php echo $this->_var['total']['tax_formated']; ?></span><?php endif; ?>
    ...
    <?php if ($this->_var['total']['aa'] > 0): ?><br/> - <?php echo $this->_var['lang']['m_46']; ?><span class="price"><?php echo $this->_var['total']['dd']; ?></span><?php endif; ?>
...
<span class="total-text"><?php echo $this->_var['lang']['goods_all_price']; ?>：</span>
 <em><?php echo $this->_var['total']['goods_price_formated']; ?></em><br/>
  ...
  <span class="total-text" style=""><?php if ($this->_var['is_group_buy'] || $this->_var['total']['exchange_integral']): ?>
