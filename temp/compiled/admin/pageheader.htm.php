...
<ul>
<li><a href="category.php?act=add" target="main_frame"><?php echo $this->_var['lang']['x_465']; ?></a></li>
<li><a href="article.php?act=add" target="main_frame"><?php echo $this->_var['lang']['article_add']; ?></a></li>
</ul>
</div>
<script>
function show_popup(){
