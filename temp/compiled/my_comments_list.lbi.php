        ...
        <div class="content_head" <?php if (($this->_foreach['comments']['iteration'] == $this->_foreach['comments']['total'])): ?> style="border-bottom:0px solid #CCC;"<?php else: ?>style="border-bottom:1px solid #CCC;"<?php endif; ?>>
          <div class="info">
            <div class=" comment_star">
              <div class="name"><?php if ($this->_var['value']['hide_username'] == 1): ?><?php echo $this->_var['lang']['m_36']; ?><?php else: ?><?php echo $this->_var['value']['user_name']; ?><?php endif; ?>
...
?>
<p style=" color:#F60; border-top:1px dashed #e5e5e5; padding-top:8px; margin-top:10px"><span><?php echo $this->_var['lang']['m_37']; ?>&nbsp;<?php echo $this->_var['val']['user_name']; ?>&nbsp;<?php echo $this->_var['lang']['m_38']; ?><br></span><p style="color:#999;"><?php echo $this->_var['val']['content']; ?><p></p> 
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>          
        </div>
      </li>
       <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
