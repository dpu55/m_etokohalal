...
<body class="eth_v1_mobile page-goods">
<script type="text/javascript">
var process_request = "<?php echo $this->_var['lang']['process_request']; ?>";
var m_696 = "<?php echo $this->_var['lang']['m_696']; ?>";
var m_697 = "<?php echo $this->_var['lang']['m_697']; ?>";
var m_698 = "<?php echo $this->_var['lang']['m_698']; ?>";
</script>
...
<div class="main"> 
      ...
      <div class="tab_nav">
        <div class="header">
          <div class="h-left"><a class="sb-back" href="javascript:history.back(-1)" title="<?php echo $this->_var['lang']['m_166']; ?>"><i class="fa fa-chevron-leftt"></i></a></div>
          <div class="h-mid">
            <ul>
              <li><a href="javascript:;" class="tab_head on"   id="goods_ka1" onClick="setGoodsTab('goods_ka',1,3)"><?php echo $this->_var['lang']['m_365']; ?></a></li>
              <li><a href="javascript:;" class="tab_head" id="goods_ka2" onClick="setGoodsTab('goods_ka',2,3)"><?php echo $this->_var['lang']['m_376']; ?></a></li>
              <li><a href="javascript:;" class="tab_head" id="goods_ka3" onClick="setGoodsTab('goods_ka',3,3)"><?php echo $this->_var['lang']['comments_rank']; ?></a></li>
          ...
          <div class="h-right">
            ...
            <a href="flow.php" class="show_cart"><em class="global-nav__nav-shop-cart-num" id="ECS_CARTINFO"><?php $k = array (
  'name' => 'cart_info',
);
          ...
          <form action="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" method="post" id="purchase_form" name="ECS_FORMBUY" >
            <div class="product_info">
              <div class="info_dottm">
                <h3 class="name"><?php echo sub_str($this->_var['goods']['goods_name'],200); ?></h3>
<!--                <div class="right"><a onClick="tiaozhuan()"><div id="pro_share" class="share"></div></a></div>-->
                <div class="right"><a onClick="tiaozhuan()"><i class="fa fa-share-square"></i></a></div>
              </div>
              
             
              <div class="eth_price_box">
				...
				<div class="subNavBox"> 
					<div class="subNav"><strong><?php echo $this->_var['lang']['m_382']; ?></strong></div>
					<ul class="navContent"> 
...
?>
					...
					<li style=" border-bottom:1px solid #eeeeee">
						<div class="title1"><?php echo $this->_var['lang']['number']; ?></div>
						<div class="item1">
				...
				<div class="ui-sx bian1"> 
				<div class="subNavBox"> 
					<div class="subNav on"><strong><?php echo $this->_var['lang']['number']; ?></strong></div>
					<ul class="navContent" style="display: block;"> 
					<li style=" border-bottom:1px solid #eeeeee">
						<div class="item1">
						 <script language="javascript" type="text/javascript">  function goods_cut(){var num_val=document.getElementById('number');  var new_num=num_val.value;  var Num = parseInt(new_num);  if(Num>1)Num=Num-1;  num_val.value=Num;}  function goods_add(){var num_val=document.getElementById('number');  var new_num=num_val.value;  var Num = parseInt(new_num);  Num=Num+1;  num_val.value=Num;} </script>
						 <span class="ui-number">
						  <button type="button" class="decrease" onclick="goods_cut();changePrice();"><i class="fa fa-minus"></i></button>
						  ...
						  <button type="button" class="increase" onclick="goods_add();changePrice();"><i class="fa fa-plus"></i></button>
						  </span>
					  </div>    
					</li>
					   </ul>  
              ...
              <ul class="price_dottm">
               <li style=" text-align:left"><?php echo $this->_var['lang']['discount']; ?> <?php echo $this->_var['zhekou']; ?> <?php echo $this->_var['lang']['m_355']; ?></li>
               <li><?php echo $this->_var['review_count']; ?> <?php echo $this->_var['lang']['m_379']; ?></li>
               <li style=" text-align:right"><?php echo $this->_var['order_num']; ?> <?php echo $this->_var['lang']['m_380']; ?></li> 
              </ul>
              </div>             
...
?>       
     ...
     <span><?php echo $this->_var['lang']['m_381']; ?></span>  
...
?>
        <?php if ($this->_foreach['name']['iteration'] < 2): ?>
           <span><?php echo $this->_var['lang']['m_381']; ?></span>
     <p><?php echo $this->_var['lang']['btn_buy']; ?> <?php echo $this->_var['price_list']['number']; ?> <?php echo $this->_var['lang']['m_44']; ?> &nbsp;<?php echo $this->_var['lang']['preferences_price']; ?> <?php echo $this->_var['price_list']['format_price']; ?></p>
      <?php endif; ?>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
?>
          ...
          <li><img src="themesmobile/68ecshopcom_mobile/images/hui.png"><?php echo $this->_var['lang']['btn_buy']; ?> <?php echo $this->_var['price_list']['number']; ?> <?php echo $this->_var['lang']['m_44']; ?>&nbsp; <?php echo $this->_var['lang']['preferences_price']; ?> <?php echo $this->_var['price_list']['format_price']; ?></li> 
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          </ul>
     <?php endif; ?>
...
<div class="ui-sx bian1"> 
<div class="subNavBox" > 
	<div class="subNav"><strong><?php echo $this->_var['lang']['m_383']; ?></strong></a></div>
    <ul class="navContent" > 
    <li  class="user_price">			
...
<div style=" height:1px; background:#eeeeee; margin-top:-1px;"></div>
<div class="is_scroll">
<section id="search_ka">
<div class="ui-sx bian1"> 
<div class="subNavBox" > 
<div class="subNav" style=" border:0;"><a href="pocking.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" style=" border:0px;"><strong><?php echo $this->_var['lang']['m_368']; ?></strong></a></div>
</div>
</div> 
...
<dd><strong><?php echo $this->_var['lang']['m_128']; ?> <a href="supplier.php?suppId=<?php echo $this->_var['suppid']; ?>" style="color:#333; font-size:18px;"><?php echo $this->_var['shopname']; ?></a></strong><em><?php echo $this->_var['userrank']; ?></em></dd>
</dl>
<ul>
<li><span><?php echo $this->_var['lang']['m_58']; ?></span><strong><?php if ($this->_var['c_rank'] > 0): ?><?php echo $this->_var['c_rank']; ?><?php else: ?>5.0<?php endif; ?></strong><em><?php if ($this->_var['c_rank'] > 0): ?><?php if ($this->_var['c_rank'] <= 2): ?><?php echo $this->_var['lang']['m_59']; ?><?php elseif ($this->_var['c_rank'] > 2 && $this->_var['c_rank'] <= 4): ?><?php echo $this->_var['lang']['m_60']; ?><?php else: ?><?php echo $this->_var['lang']['m_61']; ?><?php endif; ?><?php else: ?><?php echo $this->_var['lang']['m_61']; ?><?php endif; ?></em></li>
<li><span><?php echo $this->_var['lang']['m_62']; ?></span><strong><?php if ($this->_var['serv_rank'] > 0): ?><?php echo $this->_var['serv_rank']; ?><?php else: ?>5.0<?php endif; ?></strong><em><?php if ($this->_var['serv_rank'] > 0): ?><?php if ($this->_var['serv_rank'] <= 2): ?><?php echo $this->_var['lang']['m_59']; ?><?php elseif ($this->_var['serv_rank'] > 2 && $this->_var['serv_rank'] <= 4): ?><?php echo $this->_var['lang']['m_60']; ?><?php else: ?><?php echo $this->_var['lang']['m_60']; ?><?php endif; ?><?php else: ?><?php echo $this->_var['lang']['m_61']; ?><?php endif; ?></em></li>
<li><span><?php echo $this->_var['lang']['m_63']; ?></span><strong><?php if ($this->_var['shipp_rank'] > 0): ?><?php echo $this->_var['shipp_rank']; ?><?php else: ?>5.0<?php endif; ?></strong><em><?php if ($this->_var['shipp_rank'] > 0): ?><?php if ($this->_var['shipp_rank'] <= 2): ?>低<?php elseif ($this->_var['shipp_rank'] > 2 && $this->_var['shipp_rank'] <= 4): ?><?php echo $this->_var['lang']['m_60']; ?><?php else: ?><?php echo $this->_var['lang']['m_59']; ?><?php endif; ?><?php else: ?><?php echo $this->_var['lang']['m_59']; ?><?php endif; ?></em></li>
</ul>
</div>
<div class="s_dianpu">
<span><a href="tel:<?php echo $this->_var['servicephone']; ?>" style=" margin-left:7%;"><em class="bg1"></em><?php echo $this->_var['lang']['m_66']; ?></a></span>
<span><a href="supplier.php?suppId=<?php echo $this->_var['suppid']; ?>" style=" margin-left:3%;"><em class="bg2"></em><?php echo $this->_var['lang']['m_67']; ?></a></span>
</div>
</section>
</div>
<?php endif; ?>
...
?>
    ...
    <h2><span></span><?php echo $this->_var['lang']['m_374']; ?></h2>
        <div class="tc_goods">
...
<section class="index_floor is_scroll">
    <h2>
      ...
      <div class="bd">
        <ul>
           <?php $_from = $this->_var['fittings']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_33403600_1582822445');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_33403600_1582822445']):
?>
          <li>
            <a href="<?php echo $this->_var['goods_0_33403600_1582822445']['url']; ?>">
              <div class="products_kuang">
                <img src="<?php echo $this->_var['goods_0_33403600_1582822445']['goods_thumb']; ?>"></div>
              <div class="goods_name"><?php echo htmlspecialchars($this->_var['goods_0_33403600_1582822445']['short_name']); ?></div>
              <div class="price" >
              <p href="<?php echo $this->_var['goods_0_33403600_1582822445']['url']; ?>"><?php echo $this->_var['goods_0_33403600_1582822445']['fittings_price']; ?> </p>
                 <a href="javascript:addToCart(<?php echo $this->_var['goods_0_33403600_1582822445']['goods_id']; ?>);" class="car">
                    <img src="themesmobile/68ecshopcom_mobile/images/xin/cutp.png">
                </a>
              </div>
            </a>
...
<a href="javascript:goTop();" class="gotop"><i class="fa fa-chevron-up"></i></a>   
<div style=" height:60px;"></div>
<div class="footer_nav">
 <ul> 
<!-- <li class="bian"><a href="index.php"><em class="goods_nav1"></em><span><?php echo $this->_var['lang']['home']; ?></span></a> </li>-->
 <li class="bian">
    <a href="index.php">
<!--    	<i class="fa fa-home"></i><span><?php echo $this->_var['lang']['home']; ?></span> -->
		<img src="themesmobile/68ecshopcom_mobile/images/menu-footer/footer-menu-home-01.png" alt=""/>
    </a>
 </li>
<!-- <li class="bian"><a href="tel:<?php $k = array (
  'name' => 'ecsmart_tel',
);
echo $this->_echash . $k['name'] . '|' . serialize($k) . $this->_echash;
?>"><em class="goods_nav2"></em><span><?php echo $this->_var['lang']['m_1']; ?></span></a> </li>-->
  <li class="bian">
  	<a href="tel:<?php $k = array (
  'name' => 'ecsmart_tel',
);
echo $this->_echash . $k['name'] . '|' . serialize($k) . $this->_echash;
?>">
  		<i class="fa fa-comment-dots"></i>
<!--  		<span><?php echo $this->_var['lang']['m_1']; ?></span>-->
  	</a> 
  </li>
<!-- <li><a href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>)" id="favorite_add"><em class="goods_nav3"></em><span><?php echo $this->_var['lang']['btn_collect']; ?></span></a></li>-->
  <li>
  	<a href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>)" id="favorite_add">
  		<i class="fa fa-heart"></i>
<!--  		<span><?php echo $this->_var['lang']['btn_collect']; ?></span>-->
  	</a>
  </li>
 </ul>
 <dl>
<!-- <dd class="flow"><a class="button active_button" href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>);"><?php echo $this->_var['lang']['btn_add_to_cart']; ?></a> </dd>-->
  <dd class="flow"><a class="button active_button" href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>);"><i class="fa fa-shopping-cart"></i></a> </dd>
 <dd class="goumai"><a style="display:block;" href="javascript:addToCart1(<?php echo $this->_var['goods']['goods_id']; ?>)"><?php echo $this->_var['lang']['button_buy']; ?></a> </dd>
 </dl>                
</div>                
<script type="text/javascript">
