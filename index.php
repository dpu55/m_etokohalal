...
if (!$smarty->is_cached('index.dwt', $cache_id))
{
	...
	//yyy添加start
	$smarty->assign('wap_index_ad',get_wap_advlist($_LANG['m_634'], 5));  //wap首页幻灯广告位
	
	$smarty->assign('wap_index_icon',get_wap_advlist($_LANG['m_635'] , 8));  //wap首页幻灯广告位
    $smarty->assign('wap_index_img',get_wap_advlist($_LANG['m_636'], 5));  //wap首页幻灯广告位
