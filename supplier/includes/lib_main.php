...
function create_shop_settiongs()
{
	...
	if($num>0){
		...
		$insql = "INSERT INTO ". $ecs->table('supplier_shop_config') ." (`id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order`, `supplier_id`) VALUES
				...
				(101, 1, 'shop_name', 'text', '', '', 'Nama Toko', 1, ".$_SESSION['supplier_id']."),
				(102, 1, 'shop_title', 'text', '', '', 'Judul Toko ', 1, ".$_SESSION['supplier_id']."),
				(103, 1, 'shop_desc', 'hidden', '', '', 'Deskripsi Toko  ', 1, ".$_SESSION['supplier_id']."),
				(104, 1, 'shop_keywords', 'text', '', '', 'Kata Kunci Toko  ', 1, ".$_SESSION['supplier_id']."),
				...
				(120, 1, 'user_notice', 'hidden', '', '', 'Pengumuman! ', 1, ".$_SESSION['supplier_id']."),
				(121, 1, 'shop_notice', 'textarea', '', '', 'Perkenalan Toko: Selamat datang, kami siap memberikan pelayanan terbaik  dengan integritas！\r\n<MARQUEE onmouseover=this.stop() onmouseout=this.start() \r\nscrollAmount=3><U><FONT color=red>\r\n<P>Layanan Telepon: 08112345678</P></FONT></U></MARQUEE>', 1, ".$_SESSION['supplier_id']."),
				(122, 1, 'shop_reg_closed', 'hidden', '1,0', '', '0', 1, ".$_SESSION['supplier_id']."),
				(123, 1, 'shop_index_num', 'textarea', '', '', '8\r\n6\r\n4', 1, ".$_SESSION['supplier_id']."),
				(124, 1, 'shop_search_price', 'textarea', '', '', '0-100000 Rupiah\r\n100000-200000 Rupiah\r\n200000-400000 Rupiah', 1, ".$_SESSION['supplier_id']."),
				(125, 1, 'close_comment', 'textarea', '', '', 'Maaf toko tutup sementara', 1, ".$_SESSION['supplier_id']."),
		...
		if($db->query($insql) === false){
        	...
        	sys_msg('Pengaturan informasi toko gagal! ', 1);
		}
		return;
	}
}
