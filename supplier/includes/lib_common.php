    ...
    if(empty($goods_id))
    {
        foreach ($res as $rows)
        {
			...
			$bb = unserialize($rows['gift']);
				...
				{
				case 0:
					$favourable[$rows['act_id']]['act_type'] = "Hadiah";
					break;
				case 1:
					$favourable[$rows['act_id']]['act_type'] = "Cashback";
					break;
				case 2:
					$favourable[$rows['act_id']]['act_type'] = "Diskon";
					break;
				}
