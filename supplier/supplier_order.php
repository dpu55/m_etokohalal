...
if ($_REQUEST['act']== 'view')
{
	 ...
	 else
	{
     ...
     $smarty->assign('ur_here', $_LANG['y_23']);
...
elseif ($_REQUEST['act'] == 'operate1')
{
	...
	$links[] = array('href' => 'supplier_rebate.php?act=list', 'text' => $_LANG['y_26']);
	if($GLOBALS['db']->query($sql)){
		...
		$rebate_order = array(
			...
			'typedec' => $_LANG['y_27'],
			'contents' => $_LANG['y_28'].$_REQUEST['order_id'].$_LANG['y_29'],
			'addtime' => gmtime()
		);
