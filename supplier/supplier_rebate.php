...
if ($_REQUEST['act'] == 'list')
{
    ...
    /* 显示模板 */
    _wap_assign_header_info($_LANG['y_10']);
...
elseif ($_REQUEST['act'] == 'view')
{
	...
	$smarty->assign('supplier', $supplier);
        ...
        $smarty->assign('ur_here',$_LANG['y_12']);    
	assign_query_info();
...
elseif ($_REQUEST['act']=='update')
{
   ...
   $rebate = array(
	...
	//修改佣金信息状态记录
		$rebate_list = array(
				'rebateid' => $rebate_id,
				'username' => $_LANG['y_13'].':'.$_SESSION['supplier_name'],
	...
	/* 提示信息 */
	$links[] = array('href' => 'supplier_rebate.php?act=list' , 'text' => $_LANG['y_16']);
	sys_msg($_LANG['y_17'], 0, $links);    
...
elseif ($_REQUEST['act']=='cancel')
{
   ...
   if (($rebate = rebateHave($rebate_id)) === false)
	...
	//修改佣金信息状态记录
		$rebate_list = array(
				'rebateid' => $rebate_id,
				'username' => $_LANG['y_18'].':'.$_SESSION['user_name'],
				'type' => REBATE_LOG_LIST,
				'typedec' => $_LANG['y_19'],
				'contents' => $_LANG['y_20'],
				'addtime' => gmtime()
...
function rebate_list($act='')
{
    ...
    while ($row = $GLOBALS['db']->fetchRow($res))
	{
		...
		$row['pay_status'] = $row['is_pay_ok'] ? $_LANG['y_21'] : $_LANG['y_22'];
