...
if ($_REQUEST['act'] == 'login')
{
    ...
    _wap_assign_header_info($_LANG['y_53'],$_LANG['y_53'],1,1,0);
...
elseif ($_REQUEST['act'] == 'signin')
{
    ...
    {
        sys_msg($_LANG['y_54'],1);
    }
    if(empty($_POST['password']))
    {
        sys_msg($_LANG['y_55'],1);
    }
