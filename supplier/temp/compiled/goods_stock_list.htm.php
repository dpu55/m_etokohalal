            ...
            <div class="order order_t">
              <form name="theForm" method="" action="" class="order_search" onsubmit='return search_stock();return false;'>
                <table width="100%" border="0">
                  <tr>
                    <td>
                      <input type="text" name="goods_name" id='goods_name' class="inputBg" placeholder="<?php echo $this->_var['lang']['y_143']; ?>" <?php if ($this->_var['filter']['goods_name']): ?>value='<?php echo $this->_var['filter']['goods_name']; ?>'<?php endif; ?>/>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <input type="text" name="goods_sn" id='goods_sn' class="inputBg" placeholder="<?php echo $this->_var['lang']['y_144']; ?>"  <?php if ($this->_var['filter']['goods_sn']): ?>value='<?php echo $this->_var['filter']['goods_sn']; ?>'<?php endif; ?>/>
                    </td>
                  </tr>
                  <tr>
                    <td>
...
?>
              <li class="goods_list_info">
                ...
                <p><?php echo $this->_var['lang']['y_145']; ?><?php echo $this->_var['item']['goods_sn']; ?></p>
				<p><?php echo $this->_var['lang']['Properties:']; ?><?php echo $this->_var['item']['goods_attr_name']; ?></p>
...
?>
                ...
                <?php else: ?>
                <p><?php echo $this->_var['lang']['y_147']; ?><span class="font"><?php echo $this->_var['item']['number_stock']; ?></span></p>
                <?php endif; ?>
              </li>
              <?php endforeach; else: ?>
              <li class="no_goods_list">
                <div class="no_goods"><?php echo $this->_var['lang']['y_148']; ?></div>
              </li>
