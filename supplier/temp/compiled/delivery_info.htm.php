        ...
        <div class="order_info_con">
			...
			<table width="100%" >
			  <tr>
				<td align="left" width='30%'>
				  <div ><strong><?php echo $this->_var['lang']['delivery_sn_number']; ?></strong></div>
				</td>
				<td align="left" width='70%'><?php echo $this->_var['delivery_order']['delivery_sn']; ?></td>
			  </tr>
			  <tr>
				<td align="left">
				  <div ><strong><?php echo $this->_var['lang']['label_shipping_time']; ?></strong></div>
				</td>
				<td align="left"><?php echo $this->_var['delivery_order']['formated_update_time']; ?></td>
			  </tr>
			  <tr>
				<td align="left">
				  <div><strong><?php echo $this->_var['lang']['label_order_sn']; ?></strong></div>
				</td>
			  ...
			  <tr>
				<td align="left">
				  <div><strong><?php echo $this->_var['lang']['label_order_time']; ?></strong></div>
				</td>
			  ...
			  <table width='100%'>
				<tr>
				  <td  align="left" width='30%'>
					<div><strong><?php echo $this->_var['lang']['label_user_name']; ?></strong></div>
				  </td>
				  <td  align="left" width='70%'><?php echo empty($this->_var['delivery_order']['user_name']) ? $this->_var['lang']['anonymous'] : $this->_var['delivery_order']['user_name']; ?></td>
				</tr>
				<tr>
				  <td align="left">
					<div><strong><?php echo $this->_var['lang']['label_how_oos']; ?></strong></div>
				  </td>
				  <td align="left"><?php echo $this->_var['delivery_order']['how_oos']; ?></td>
				</tr>
				<tr>
				  <td align="left">
					<div><strong><?php echo $this->_var['lang']['label_shipping']; ?></strong></div>
				  </td>
		  ...
		  <p class="edit" id="consignee_base"><span><?php echo $this->_var['lang']['consignee_info']; ?></span> <i></i></p>
            <div class="order_consign">
              <table width="100%" >
                <tr>
					<td  align="left" width='30%'><div><strong><?php echo $this->_var['lang']['label_consignee']; ?></strong></div></td>
					<td  align="left" width='70%'><?php echo htmlspecialchars($this->_var['delivery_order']['consignee']); ?></td>
				</tr>
				<tr>
					<td align="left" ><div><strong><?php echo $this->_var['lang']['label_email']; ?></strong></div></td>
					<td align="left" ><?php echo $this->_var['delivery_order']['email']; ?></td>
				</tr>
				<tr>
					<td align="left" ><div><strong><?php echo $this->_var['lang']['label_address']; ?></strong></div></td>
				...
				<table width='100%'>
				<tr>
					<td align="left"  width='30%'><div><strong><?php echo $this->_var['lang']['label_zipcode']; ?></strong></div></td>
					<td align="left"  width='70%'><?php echo htmlspecialchars($this->_var['delivery_order']['zipcode']); ?></td>
				</tr>
				<tr>
					<td align="left" ><div><strong><?php echo $this->_var['lang']['label_tel']; ?></strong></div></td>
					<td align="left" ><?php echo $this->_var['delivery_order']['tel']; ?></td>
				</tr>
				<tr>
					<td align="left" ><div><strong><?php echo $this->_var['lang']['label_mobile']; ?></strong></div></td>
					<td align="left" ><?php echo htmlspecialchars($this->_var['delivery_order']['mobile']); ?></td>
				</tr>
				<tr>
					<td align="left" ><div><strong><?php echo $this->_var['lang']['label_sign_building']; ?></strong></div></td>
					<td align="left" ><?php echo htmlspecialchars($this->_var['delivery_order']['sign_building']); ?></td>
				</tr>
				<tr>
					<td align="left" ><div><strong><?php echo $this->_var['lang']['label_best_time']; ?></strong></div></td>
					<td align="left" ><?php echo htmlspecialchars($this->_var['delivery_order']['best_time']); ?></td>
				</tr>
				<tr>
					<td align="left" ><div><strong><?php echo $this->_var['lang']['label_postscript']; ?></strong></div></td>
          ...
          <div class="goods_info">
            ...
            <div class="order_goods">
			  ...
			  <tr>
				<td align='left' width='20%'><div><strong><?php echo $this->_var['lang']['goods_name_brand']; ?></strong></div></td>
				<td align='left' width='20%'><div><strong><?php echo $this->_var['lang']['goods_sn']; ?></strong></div></td>
				<td align='left' width='20%'><div><strong><?php echo $this->_var['lang']['product_sn']; ?></strong></div></td>
				<td align='left' width='20%'><div><strong><?php echo $this->_var['lang']['goods_attr']; ?></strong></div></td>
				<td align='left' width='20%'><div><strong><?php echo $this->_var['lang']['label_send_number']; ?></strong></div></td>
			  </tr>
			  <?php $_from = $this->_var['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods');if (count($_from)):
    foreach ($_from AS $this->_var['goods']):
?>
			  <tr>
				<td align='left'><div> <?php echo $this->_var['goods']['goods_name']; ?> <?php if ($this->_var['goods']['brand_name']): ?>[ <?php echo $this->_var['goods']['brand_name']; ?> ]<?php endif; ?></div></td>
				<td align='left'><div><?php echo $this->_var['goods']['goods_sn']; ?></div></td>
				<td align='left'><div><?php echo $this->_var['goods']['product_sn']; ?></div></td>
				<td align='left'><div><?php echo nl2br($this->_var['goods']['goods_attr']); ?></div></td>
				<td align='left'><div><?php echo $this->_var['goods']['send_number']; ?></div></td>
			  </tr>
			  <?php endforeach; else: ?>
                <tr>
                  <td colspan='5' align='center'><span><?php echo $this->_var['lang']['y_124']; ?></span></td>
                </tr>
        ...
        <form method='POST' action='order.php?act=quick_delivery' onsubmit='return quick_delivery();'>
          <div class="order_info_con">
            <p class="one_delivery">
              <input type="text" name="express_no" id='express_no' placeholder="<?php echo $this->_var['lang']['y_125']; ?>" class="inputBg"/>
              <input type='hidden' name='order_id' value='<?php echo $this->_var['delivery_order']['order_id']; ?>'/>
              <input type="submit" value="<?php echo $this->_var['lang']['y_126']; ?>" class="one_delivery_btn" />
            </p>
          </div>
        </form>
        <?php else: ?>
        <form method='POST' action='order.php?act=cancel_delivery'>
          <div class="order_info_con">
            <p class="cancel_delivery">
              ...
              <input type='hidden' name='order_id' value='<?php echo $this->_var['delivery_order']['order_id']; ?>'/>
              <input type="submit" value="<?php echo $this->_var['lang']['y_127']; ?>" class="one_delivery_btn" />
            </p>
          </div>
        </form>
        <?php endif; ?>
