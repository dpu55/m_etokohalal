...
$back_type_arr=array('0'=>$_LANG['y_34'], '1'=>'<font color=#ff3300>'.$_LANG['y_35'].'</font>', '2'=>'<font color=#ff3300>'.$_LANG['y_36'].'</font>');
...
if ($_REQUEST['act'] == 'back_list')
{
    ...
    /* 显示模板 */
    _wap_assign_header_info($_LANG['y_37']);
...
elseif ($_REQUEST['act'] == 'back_info')
{
	...
	if($back_order)
	{
		...
		if($base_order)
		{
			...
			$base_order['tel'] = $base_order['tel'] ? $_LANG['y_39']." ".$base_order['tel'] : "";
			$base_order['tel'] .= $base_order['tel'] ? "&nbsp;&nbsp;&nbsp;&nbsp;" : "";
			$base_order['tel'] .= $base_order['mobile'] ? $_LANG['y_40']."".$base_order['mobile'] : "";
			/* 是否保价 */
    ...
    /* 显示模板 */
    _wap_assign_header_info($_LANG['y_41']);
    _wap_assign_footer_order_info();
...
elseif ($_REQUEST['act'] == 'operate')
{
    ...
    {
		$smarty->assign('ur_here', $_LANG['back_operate'] . $_LANG['y_42']);
	...
	$links[] = array('text' => $_LANG['y_43'], 'href' => 'back.php?act=back_info&back_id=' . $back_id);
    sys_msg($_LANG['y_44'], 0, $links);
...
elseif ($_REQUEST['act'] == 'operate_refund')
{
	...
	{
		$desc_back = $_LANG['y_45']." ". $order['order_id'] .$_LANG['y_42'];
...
elseif ($_REQUEST['act'] == 'remove_back')
{
        ...
        /* 返回 */		
        sys_msg($_LANG['y_46'], 0, array(array('href'=>'back.php?act=back_list' , 'text' =>$_LANG['y_47'])));
}
...
elseif ($_REQUEST['act'] == 'replay')
{
        ...
        sys_msg($_LANG['y_48'] , 0, array(array('href'=>'back.php?act=back_info&back_id='.$back_id , 'text' =>$_LANG['back'])));	
