...
if($act == 'list')
{
    ...
    _wap_assign_header_info($_LANG['01_order_list']);
...
elseif($act == 'info')
{
    ...
    {
        _wap_assign_header_info($_LANG['y_59']);
        _wap_assign_footer_order_info();
...
elseif($act == 'edit')
{
    ...
    /* 显示模板 */
    assign_query_info();
    _wap_assign_header_info($_LANG['y_60'],$_LANG['y_60'],0,1,0);
...
elseif($act == 'quick_delivery')
{
    ...
    if(empty($express_no))
    {
        sys_msg($_LANG['y_61'],1);
    }
    
    if(empty($order_id))
    {
        sys_msg($_LANG['y_62'],1);
    }
...
elseif($act == 'delivery_list')
{
    ...
    $smarty->assign('filter',$data['filter']);
    _wap_assign_header_info($_LANG['09_delivery_order']);
    _wap_assign_footer_order_info();
...
elseif($act == 'delivery_info')
{
    ...
    assign_query_info();
    _wap_assign_header_info($_LANG['y_64']);
    _wap_assign_footer_order_info();
