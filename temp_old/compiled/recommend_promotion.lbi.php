...
<section class="index_floor_lou">
  <div class="floor_body" >
    <h2>
      <em></em><?php echo $this->_var['lang']['promotion_goods']; ?><div class="geng"><a href="search.php?intro=promotion" ><?php echo $this->_var['lang']['m_6']; ?></a> <span></span></div>
    </h2>
          ...
          <li>
            <a href="<?php echo $this->_var['goods']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>">
             <div class="index_pro"> 
              ...
              <div class="timerBox" id="jstimerBox<?php echo $this->_var['key']; ?>"><?php echo $this->_var['lang']['m_56']; ?></div>
                <img src="<?php echo $this->_var['img_url']; ?><?php echo $this->_var['option']['static_path']; ?><?php echo $this->_var['goods']['thumb']; ?>">
                </div>
