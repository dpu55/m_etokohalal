...
<body class="eth_v1_mobile page-index">
...
<div id="fake-search" class="index_search">
 	<div class="logo-sticky"><img src="themesmobile/68ecshopcom_mobile/images/etokohalal-logo.png" height="20px" /></div>
  <div class="index_search_mid">
<!--  <span><img src="themesmobile/68ecshopcom_mobile/images/xin/icosousuo.png"></span>-->
  <span><i class="fa fa-search"></i></span>
    <input  type="text" id="search_text" class="search_text" value="<?php echo $this->_var['lang']['m_358']; ?>"/>
  </div>
</div>
...
<a href="javascript:goTop();" class="gotop"><i class="fa fa-chevron-up"></i></a>                     
 ...
 <h2> <span class="close"><img src="themesmobile/68ecshopcom_mobile/images/close.png"></span><?php echo $this->_var['lang']['m_359']; ?></h2>

 <div id="mallSearch" class="search_mid">
        <div id="search_tips" style="display:none;"></div>
          <ul class="search-type">
          	<li <?php if ($_REQUEST['type'] == 0): ?> class="cur" <?php endif; ?> num="0"><?php echo $this->_var['lang']['m_360']; ?></li>
          	<li <?php if ($_REQUEST['type'] == 1): ?> class="cur" <?php endif; ?> num="1"><?php echo $this->_var['lang']['m_256']; ?></li>
          </ul>	
          ...
          <form class="mallSearch-form" method="get" name="searchForm" id="searchForm" action="search.php" onSubmit="return checkSearchForm()">
              ...
              <div class="mallSearch-input">
                <div id="s-combobox-135">
                    <input aria-haspopup="true" role="combobox" class="s-combobox-input" name="keywords" id="keyword" tabindex="9" accesskey="s" onkeyup="STip(this.value, event);" autocomplete="off"  value="<?php if ($this->_var['search_keywords']): ?><?php echo htmlspecialchars($this->_var['search_keywords']); ?><?php else: ?><?php echo $this->_var['lang']['m_361']; ?><?php endif; ?>" onFocus="if(this.value=='<?php echo $this->_var['lang']['m_361']; ?>'){this.value='';}else{this.value=this.value;}" onBlur="if(this.value=='')this.value='<?php echo $this->_var['lang']['m_361']; ?>'" type="text">
                </div>
 ...
 <!--
                                    ...
                                    <form action="search.php" method="post" id="searchForm" name="searchForm">
                                        <div>
											<select id='search_type' name="search_type" style="width:15%;">
												<option value='search'><?php echo $this->_var['lang']['m_360']; ?></option>
												<option value='stores'><?php echo $this->_var['lang']['m_256']; ?></option>
											</select>
                                            <input class="text" type="search" name="keywords" id="keywordBox" autofocus>
                                            <button type="submit" value="<?php echo $this->_var['lang']['search']; ?>" ></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <section class="mix_recently_search"><h3><?php echo $this->_var['lang']['hot_search']; ?></h3>
...
?>
   ...
   <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    ...
    <?php else: ?>
    <div class="recently_search_null"><?php echo $this->_var['lang']['m_362']; ?></div>
    <?php endif; ?>
    </section>
                        </div>  
