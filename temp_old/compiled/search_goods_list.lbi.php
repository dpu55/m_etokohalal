...
<img src="<?php echo $this->_var['img_url']; ?><?php echo $this->_var['goods']['goods_thumb']; ?>">
</div>
<div class="title_box">
...
<dl class="goods_price">
  ...
  <dd><font><?php echo $this->_var['lang']['price']; ?><?php echo $this->_var['goods']['shop_price_formated']; ?></font>
  ...
  <?php else: ?> 
  <dt> <span id="ECS_GOODS_AMOUNT"><?php echo $this->_var['goods']['shop_price_formated']; ?></span><font><?php echo $this->_var['lang']['price']; ?><?php echo $this->_var['goods']['market_price']; ?></font><?php if ($this->_var['goods']['is_shipping']): ?><em>包邮</em><?php endif; ?>
	<?php if ($this->_var['goods']['give_integral_2'] == '-1'): ?>
	  <p><?php echo $this->_var['lang']['goods_give_integral']; ?> <?php echo $this->_var['goods']['give_integral']; ?> <?php echo $this->_var['lang']['m_8']; ?></p>
	  <?php elseif ($this->_var['goods']['give_integral_2'] > 0): ?>
	  <p><?php echo $this->_var['lang']['goods_give_integral']; ?> <?php echo $this->_var['goods']['give_integral']; ?> <?php echo $this->_var['lang']['m_8']; ?></p>
