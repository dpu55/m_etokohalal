...
if ($_REQUEST['act'] == 'tipword')
{
	...
	while ($rows_www_68ecshop_com = $db->fetchRow($res_www_68ecshop_com))
    {
		...
		{  
			$rows_www_68ecshop_com['keyword_cat'] =  '<a href="' . $rows_www_68ecshop_com['keyword_cat_url'] . '"><font color=#666>cari di kategori <font color=#cc0000>'. $rows_www_68ecshop_com['keyword_cat'] .'</font></font></a>';
