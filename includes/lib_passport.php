 ...
 * @return bool $bool
 */
function register_by_mobile ($username, $password, $mobile, $other = array(),$pre_mobile_phone='')
{
	return _register($username, $password, $mobile, $other, 'mobile',$pre_mobile_phone);
}
 ...
 * @return boolean
 */
function _register ($username, $password, $email_or_mobile, $other = array(), $register_type = 'email',$pre_mobile_phone='')
{
	/* 检查注册是否关闭 */
	...
	if($register_type == 'mobile')
	{
		$result = $GLOBALS['user']->add_user_by_mobile($username, $password, $mobile,$pre_mobile_phone);
	}
