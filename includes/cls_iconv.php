...
class Chinese
{
    ...
    var $config = array(
        ...
        'source_lang'      => '',                // 字符的原编码
        'target_lang'      => '',                // 转换后的编码
        'GBtoBIG5_table'   => 'gb-big5.table',   // Bahasa转换为繁体中文的对照表
        'BIG5toGB_table'   => 'big5-gb.table',   // 繁体中文转换为Bahasa的对照表
        'GBtoUTF8_table'   => 'gb_utf8.php',     // Bahasa转换为UTF-8的对照表
     ...
     *
     * 详细说明
     * @形参      数字 $c Bahasa汉字的UNICODE编码的10进制
     * @访问      内部
     * @返回      字符串
     * @throws
     */
