...
if (!empty($_REQUEST['act']) && $_REQUEST['act'] == 'pickup_info')
{
	...
	if (count($p_info) == 0)
	{
		$pickup_list_info = "<div class='pick_col'>".$_LANG['m_373']."</div>";
	}
	else
	{
		$pickup_list_info = "<div><span>".$_LANG['m_626']."</span><br /><ul>";
		foreach ($p_info as $p_infos)
		{
			$pickup_list_info .= "<li>" . $p_infos['shop_name'] . "<br />".$_LANG['m_627'] . $p_infos['address'] .
								"<br />".$_LANG['m_628'] . $p_infos['contact'] . "&nbsp;&nbsp;&nbsp;&nbsp;".$_LANG['m_629'] . $p_infos['phone'] . "</li>";
		}
...
function region_select($type, $parent_id, $start_id = "")
{
	switch ($type)
	{
		case 1 : $select_id = 'country_list'; $select_name = $_LANG['m_630']; $_js = " onchange='get_region_list(2,this.value)'"; break;
		case 2 : $select_id = 'province_list'; $select_name = $_LANG['m_631']; $_js = " onchange='get_region_list(3,this.value)'"; break;
		case 3 : $select_id = 'city_list'; $select_name = $_LANG['m_632']; $_js = " onchange='get_region_list(4,this.value)'"; break;
		case 4 : $select_id = 'district_list'; $select_name = $_LANG['m_633']; $_js = " onchange='get_pickup_point_list(this.value)'"; break;
	}
	...
	else
	{
		...
		$region_info .= "<option value='0'>".$_LANG['all_option'] . $select_name . "</option>";
