...
html = '<div class="touchweb_com-indexPop pop_add-cart show"><div class="inner"><div class="content_name"><div><i class="fa fa-check-circle"></i></div><p>'+m_696+'</p></div><div id="mcart_confirm_popup_btns" class="btn_box"><a href="javascript:cancel_div()" class="btn btn_cancel">'+m_697+'</a><a href="flow.php" class="btn btn_confirm">'+m_698+'</a></div></div></div>';
...
html = '<div class="touchweb_com-indexPop pop_add-cart show" ><div class="inner"><div class="content_name"><div><i class="fa fa-love"></i></div><p>添加成功！<br>商品已成功加入购物车</p></div><div id="mcart_confirm_popup_btns" class="btn_box"><a href="flow.php" class="btn btn_cancel">再逛逛</a><a href="flow.php" class="btn btn_confirm">去购物车</a></div></div></div>';
