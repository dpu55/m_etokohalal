...
if($_REQUEST['act'] == 'order_lise')
{
    ...
    $_LANG['shopping_money'] = $_LANG['m_655'];
    $_LANG['than_market_price'] = $_LANG['m_656'];
    /*
     * 计算订单的费用
     */
...
elseif($_REQUEST['act'] = 'done')
{
    ...
    $smarty->assign('total',      $total);
    $smarty->assign('goods_list', $cart_goods);
    $smarty->assign('order_submit_back', '<a href="index.php">'.$_LANG['back_home'].'</a> or <a href="user.php">'.$_LANG['user_center'] .'</a>'); // 返回提示
