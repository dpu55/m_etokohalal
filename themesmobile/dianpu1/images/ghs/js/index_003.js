...
function clearBatchCart() {
    ...
    if (i == 0) {
        ...
        if (!confirm('Anda yakin ingin menghapus item ini dari keranjang belanja?')) return false;
...
function removeSelectedCartGoods() {
    ...
    if (i == 0) {
        alert('Silakan pilih item yang ingin Anda hapus!');
        exit

    }
    if (!confirm('Anda yakin ingin menghapus item yang dipilih dari keranjang belanja?')) return false;
    $("input[name='cart_goods']").each(function() {
        if ($(this).attr("checked")) {
            var checked = $(this).attr("checked");
            var str = $(this).val();
...
$(document).ready(function() {
    ...
    $(".tuan_search_btn").click(function() {
        ...
        var cate = $("#t").val();
        if (keyword == "" || keyword == "Masukkan apa yang akan dicari") {
    ...
    $("#header_search_sub").click(function() {
        ...
        if (keywords == "" || keywords == "Masukkan apa yang akan dicari") {
            alert("Silakan masukkan apa yang Anda cari");
            $("#m_keywords").focus();
            return false
