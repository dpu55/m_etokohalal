		...
		addFavorite: function(title, url) {
			...
			try{
				if (document.all) {
					...
					alert("Maaf, browser Anda tidak mendukung operasi ini!\n Harap gunakan bilah menu atau Ctrl + D untuk menandai situs ini.");
				}
			}
			catch(e){
				alert('Maaf, browser Anda tidak mendukung operasi ini!\n Harap gunakan bilah menu atau Ctrl + D untuk menandai situs ini.');
...
(function(){
    ...
    $(function(){
        $('.layout-main').delegate(cssId,'click',function(){
            ...
            dialog += '#add-to-cart .c-title strong{font:400 18px "Roboto"}';
