...
$_LANG['license_L'] = 'Temporary';
$_LANG['license_S'] = 'Business';
$_LANG['license_O'] = 'enterprise';
$_LANG['license_T'] = 'experience';
$_LANG['license_no'] = 'Free Admission';
$_LANG['license_test'] = 'Free Admission';
...
$_LANG['clear_calculator'] = 'Eliminate';
$_LANG['backspace'] = 'Backspace';
...
$_LANG['new_feedback'] = 'Comments:';
$_LANG['new_comments'] = 'Unaudited comments:';

$_LANG['system_info'] = 'system information';
$_LANG['os'] = 'Server Operating System:';
$_LANG['web_server'] = 'Web server:';
$_LANG['php_version'] = 'PHP Edition:';
$_LANG['mysql_version'] = 'MySQL Edition:';
$_LANG['gd_version'] = 'GD Edition:';
$_LANG['zlib'] = 'Zlib Support:';
$_LANG['ecs_version'] = 'ECShop Edition:';
$_LANG['install_date'] = 'install date:';
$_LANG['ip_version'] = 'IP Library version:';
$_LANG['max_filesize'] = 'Maximum size of file upload:';
$_LANG['safe_mode'] = 'safe mode:';
$_LANG['safe_mode_gid'] = 'safe mode GID:';
$_LANG['timezone'] = 'time zone:';
$_LANG['no_timezone'] = 'No need to set up';
$_LANG['socket'] = 'Socket Support:';
$_LANG['ec_charset'] = 'Code:';

$_LANG['remove_install'] = 'You have not deleted the install folder yet. For security reasons, we recommend that you delete the install folder.';
$_LANG['remove_upgrade'] = 'You have not deleted the upgrade folder yet. For security reasons, we recommend that you delete the upgrade folder.';
$_LANG['remove_demo'] = 'You have not deleted the demo folder yet. For security reasons, we recommend that you delete the demo folder.';
$_LANG['temp_dir_cannt_read'] = 'If your server has open_base_dir and does not contain %s，you will not be able to upload files.';
$_LANG['not_writable'] = '%s Directory not writable，%s';
$_LANG['data_cannt_write'] = 'You will not be able to upload packaging, greeting cards, brands and other photo files.';
$_LANG['afficheimg_cannt_write'] = 'You will not be able to upload the image file of the advertisement.';
$_LANG['brandlogo_cannt_write'] = 'You will not be able to upload brand image files.';
$_LANG['cardimg_cannt_write'] = 'You will not be able to upload the picture file of the greeting card.';
...
//-- 关于我们
/*------------------------------------------------------ */
$_LANG['team_member'] = 'ECSHOP Team members';
$_LANG['before_team_member'] = 'ECSHOP Contributor';

$_LANG['director'] = 'Project planning';
$_LANG['programmer'] = 'program development';
$_LANG['ui_designer'] = 'Interface design';
$_LANG['documentation'] = 'Document sorting';
$_LANG['special_thanks'] = 'Special thanks';
$_LANG['official_site'] = 'Official website';
$_LANG['site_url'] = 'Website address:';
...
$_LANG['shop_country'] = 'Host country';
$_LANG['shop_province'] = 'Province where';
$_LANG['shop_city'] = 'City where';
