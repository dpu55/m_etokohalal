...
$_LANG['input_sn'] = 'Input product number：<br/>（One line per row.）';
...
// 批量上传商品的字段
$_LANG['upload_goods']['goods_name'] = 'Product name';
...
$_LANG['upload_goods']['goods_img'] = 'Product pictures';
$_LANG['upload_goods']['goods_thumb'] = 'Product thumbnails';
$_LANG['upload_goods']['keywords'] = 'Key words of products';
