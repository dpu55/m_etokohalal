...
$_LANG['catedit_fail'] = 'Category edit failed';
$_LANG['remove_fail'] = 'Delete failed';
$_LANG['edit_fail'] = 'Editor failure';
$_LANG['enter_int'] = 'Please enter an integer';
$_LANG['articleadd_succeed'] = 'Successful addition of articles';
$_LANG['articleedit_succeed'] = 'Article %s Editor Successful';
$_LANG['articlename_exist'] = 'Article %s already exists';
