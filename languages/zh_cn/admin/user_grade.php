...
$_LANG['total_amount'] = 'Total sum';
$_LANG['proportion']   = 'Proportion';
$_LANG['split_money']  = 'Divided into amount';
$_LANG['status']	   = 'state';
$_LANG['total_split_money'] = 'Total share amount';
...
$_LANG['distribor_list'] = 'Distributor list';

/* 表单相关语言项 */
$_LANG['password'] = 'Password';
$_LANG['confirm_password'] = 'confirm password';
$_LANG['newpass'] = 'new password';
$_LANG['question'] = 'Password hint question';
$_LANG['answer'] = 'Password prompt question answer';
$_LANG['gender'] = 'gender';
...
$_LANG['parent_remove'] = 'Departure from recommendation';
$_LANG['affiliate_user'] = 'Recommended member';
$_LANG['show_affiliate_users'] = 'View recommended list';
$_LANG['show_affiliate_orders'] = 'View recommended order details';
$_LANG['affiliate_lever'] = 'grade';
$_LANG['affiliate_num'] = 'Number of people';
$_LANG['page_note'] = 'This list shows all member information recommended by the user,';
...
/* 提示信息 */
$_LANG['username_exists'] = 'There is already an identical username.';
$_LANG['email_exists'] = 'The email address already exists.';
$_LANG['edit_user_failed'] = 'Failed to modify member information.';
$_LANG['invalid_email'] = 'An illegal email address was entered.';
...
$_LANG['email_not_allow'] = 'Mail not allowed';
