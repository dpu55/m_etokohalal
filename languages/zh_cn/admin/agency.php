...
/* 列表页 */
$_LANG['agency_name'] = 'Name of office';
$_LANG['agency_desc'] = 'Office description';

$_LANG['agency_name_exist'] = 'The name of the office already exists. Please change it to another name.';
$_LANG['agency_edit_fail'] = 'Error in editing office name. Please try again.';
...
$_LANG['back_agency_list'] = 'Return to Office List';

$_LANG['js_languages']['region_exists'] = 'The region already exists.';
$_LANG['js_languages']['no_agencyname'] = 'No office name was given.';
