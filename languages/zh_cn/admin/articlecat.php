...
$_LANG['type'] = 'Classification type';
$_LANG['type_name'][COMMON_CAT] = 'General classification';
$_LANG['type_name'][SYSTEM_CAT] = 'System classification';
...
$_LANG['not_allow_remove'] = 'The system retains classification and does not allow deletion';
...
/* 提示信息 */
$_LANG['catname_exist'] = 'Classification name %s already exists';
$_LANG['parent_id_err'] = 'Classification name %s the parent category cannot set the cost itself or its own sub-categories';
...
$_LANG['no_catname'] = 'Please fill in the classification name.';
...
$_LANG['notice_isopen'] ='Does the article classification appear in the main navigation bar in the front desk?';

/*JS 语言项*/
$_LANG['js_languages']['no_catname'] = 'No category name was entered';
$_LANG['js_languages']['sys_hold'] = 'Systems retain classifications, and subclassifications are not allowed to be added.';
