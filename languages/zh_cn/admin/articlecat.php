...
/* 提示信息 */
$_LANG['catname_exist'] = 'Category name %s already exist';
...
$_LANG['continue_add'] = 'Add new';
$_LANG['catadd_succed'] = 'Successfully added';
$_LANG['catedit_succed'] = 'Category %s editorial success';
$_LANG['back_list'] = 'Back';
$_LANG['continue_add'] = 'Add new';
