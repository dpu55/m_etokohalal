...
$_LANG['reset_button'] = 'Reduction';

$_LANG['back_list'] = 'Returns the editing language entry';
...
$_LANG['language_files']['shopping_flow'] = 'Shopping Process Language Package';
$_LANG['language_files']['user'] = 'Membership Center Language Package';

/* 操作描述 */
$_LANG['handle_tips'] = 'Please enter the language keywords you need to modify!';
$_LANG['file_attribute'] = 'Current language package files have no read and write permission! In this way, you will not be able to edit language items.';
