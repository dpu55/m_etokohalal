<?php
/* 红包类型字段信息 */
$_LANG['takegoods_type_list']='Bill of lading type list';
$_LANG['takegoods_type_add']='add voucher type';
$_LANG['type_money']='amount of bill of lading';
$_LANG['type_money_count']='number of times available';
$_LANG['type_money_c']='times';
$_LANG['type_money_all']='total amount of bill of lading';
$_LANG['send_count']='number of releases';
$_LANG['use_startdate_notic']='This type of bill of lading can only be used if the current time is between the starting date and the deadline';
$_LANG['type_name_exist']='This type of name already exists!';
$_LANG['continus_add']='Continue adding the type of bill of lading';
$_LANG['back_list']='Return to the list of pick-up voucher types';
$_LANG['attradd_succed']='Operation succeeded!';
$_LANG['use_date_valid']='valid date';
$_LANG['add_time']='Waktu ditambahkan';
$_LANG['is_used']='used times';
$_LANG['user_name']='user';
$_LANG['used_time_last']='last-Waktu';

$_LANG['js_languages']['send_count_empty'] = 'Please enter the quantity issued!';
$_LANG['js_languages']['send_count_isnumber'] = 'Quantity must be in digital format!';
$_LANG['js_languages']['type_name_empty'] = 'Please enter the type name of the bill of lading!';
$_LANG['js_languages']['type_money_empty'] = 'Please enter the amount of the bill of lading!';
$_LANG['js_languages']['type_money_isnumber'] = 'The amount of bill of lading must be in digital format!';
$_LANG['js_languages']['use_start_date_empty'] = 'Use start date cannot be empty';
$_LANG['js_languages']['use_end_date_empty'] = 'Use end date cannot be empty';
$_LANG['js_languages']['use_start_lt_end'] = 'Use start date should not be greater than end date';

$_LANG['send_takegoods'] = 'Issuance of bill of lading';
$_LANG['send_valucard_count'] ='Quantity of this issue';
$_LANG['valuecard_sn_notic'] = 'Tip: The number of the bill of lading consists of "8-digit random number or letter + 4-digit serial number".';
$_LANG['bonustype_edit'] = 'Edit Storage Card Type';
$_LANG['valuecard_have'] = 'A large number of stored-value cards have been issued under this type, which can not be deleted!';
$_LANG['continue_add'] = 'Continue adding storage cards';
$_LANG['back_takegoods_list'] = 'Return to the list of pick-up vouchers';

$_LANG['creat_takegoods'] = 'Generated ';
$_LANG['creat_takegoods_num'] = ' Bill of lading number';
$_LANG['takegoods_sn_error'] = 'The number of the bill of lading must be a number.!';
$_LANG['takegoods_list'] = 'Bill of lading list';
$_LANG['no_use'] = 'not used';
$_LANG['bonus_sn'] = 'Bill of lading number';
$_LANG['tg_pwd'] = 'Password';
$_LANG['batch_drop_success'] = 'Successfully deleted %d pick-up vouchers';
...
$_LANG['goods_search'] = 'Cari';
$_LANG['select_from'] = 'Optional product';
$_LANG['select_action'] = 'Operation';
$_LANG['select_to'] = 'Configure product';

$_LANG['tg_type_name'] = 'Types of bill of lading';

$_LANG['takegoods_order_info'] = 'Details of delivery';
$_LANG['prev'] = 'Prev Bill of Lading';
$_LANG['next'] = 'Next Bill of Lading';

$_LANG['type_name'] = 'Ticket Type Name';

$_LANG['takegoods_order_list'] = 'Pick up list';
$_LANG['takegoods_order_list_all'] = 'Full pick-up list';
...
$_LANG['goods_cat'] = 'Choosing categories of products';
$_LANG['goods_brand'] = 'Product brand';
$_LANG['goods_key'] = 'Product keyword';
...
$_LANG['sendbonus_count'] = 'A total of %d red envelopes were sent.';
...
$_LANG['bonustype_view'] = 'View detail';
...
$_LANG['user_id'] = 'User';
$_LANG['used_time'] = 'se time';
$_LANG['order_id'] = 'Order ID';
$_LANG['send_mail'] = 'Send emails';
$_LANG['emailed'] = 'Notifikasi email';
...
$_LANG['sendtouser']='Red Packet for Designated Users';
$_LANG['senduserrank']='Return Packets at User Level';
$_LANG['userrank']='user level';
$_LANG['select_rank']='select membership level...';
$_LANG['keywords']='Kata Kunci:';
$_LANG['userlist']='List Keanggotaan:';
$_LANG['send_to_user']='Reward the following users';
$_LANG['search_users']='search membership';
$_LANG['confirm_send_bonus']='confirm the sending of red packets';
$_LANG['bonus_not_exist']='The red envelope does not exist';
$_LANG['success_send_mail']='%d mail has been added to the mailing list';
$_LANG['send_continue']='continue issuing red envelopes';
?>