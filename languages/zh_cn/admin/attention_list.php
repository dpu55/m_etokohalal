...
$_LANG['pri'][1] = 'High';
$_LANG['goods_edit'] = 'Edited goods';
$_LANG['finish_list'] = ' %s records have been inserted. Please wait a moment.~';
$_LANG['finishing'] = 'Generating, please wait a moment';
$_LANG['edit_ok'] = 'Successful operation！';
$_LANG['batch_note'] = 'Insert all items updated after this date into the sending queue：';
?>