...
$_LANG['free_shipping'] = 'The tick indicates that this commodity will not incur freight charges, otherwise it will be calculated according to normal freight charges.';
...
$_LANG['products_title'] = 'Trade name：%s';
$_LANG['products_title_2'] = 'Item number：%s';
$_LANG['good_shop_price'] = '（Commodity price：%d）';
