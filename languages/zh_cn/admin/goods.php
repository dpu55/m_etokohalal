...
$_LANG['continue_add_goods'] = 'Add';
$_LANG['back_goods_list'] = 'Back';
$_LANG['add_goods_ok'] = 'Successful addition of goods.';
$_LANG['edit_goods_ok'] = 'Edit product is successful.';
$_LANG['trash_goods_ok'] = 'Put the goods in the recycling bin successfully.';
$_LANG['restore_goods_ok'] = 'Success in restoring product.';
...
//-- 商品列表
/*------------------------------------------------------ */
$_LANG['goods_cat'] = 'Semua Kategori';
...
$_LANG['is_new'] = 'Baru';
$_LANG['is_hot'] = 'Hot';
$_LANG['is_promote'] = 'Spesial';
$_LANG['all_type'] = 'Semua yang Direkomendasikan';
$_LANG['sort_order'] = 'Recommended sort';

$_LANG['goods_name'] = 'Nama Produk';
$_LANG['goods_sn'] = 'Id Produk';
$_LANG['shop_price'] = 'Harga';
$_LANG['is_on_sale'] = 'Tampil?';
...
$_LANG['new'] = 'New';
$_LANG['not_new'] = 'Cancel new';
$_LANG['hot'] = 'Hot';
$_LANG['not_hot'] = 'Cancel hot';
$_LANG['move_to'] = 'Pindahkan';

$_LANG['pass_audit'] = 'Audit pass';
...
$_LANG['tab_linkgoods'] = 'Related Product';
$_LANG['tab_groupgoods'] = 'Parts of product';
$_LANG['tab_article'] = 'Related articles';

$_LANG['lab_goods_name'] = 'Nama Produk:';
$_LANG['lab_goods_sn'] = 'Product Id.';
$_LANG['lab_goods_cat'] = 'Kategori Produk';
$_LANG['lab_other_cat'] = 'Extended category:';
$_LANG['lab_goods_brand'] = 'Merek Produk:';
...
$_LANG['lab_cost_price'] = 'Amount of share:';
$_LANG['lab_promote_date'] = 'Waktu Promosi';
$_LANG['lab_picture'] = 'Upload Gambar Produk:';
$_LANG['lab_thumb'] = 'Upload Produk Thumbnails:';
...
$_LANG['lab_goods_weight'] = 'Berat Produk:';
$_LANG['unit_g'] = 'gram';
$_LANG['unit_kg'] = 'kg';
$_LANG['lab_goods_number'] = 'Jumlah Produk dalam Stok:';
$_LANG['lab_warn_number'] = 'Batas Minimum Stok:';
$_LANG['lab_integral'] = 'Amount of integral purchase:';
...
$_LANG['notice_user_price'] = 'Saat harga membership bernilai -1, berarti harga membership dikalkulasi berdasarkan diskon level membership. Anda juga dapat menentukan harga pada setiap membership level.';
$_LANG['notice_goods_type'] = 'Silahkan pilih tipe produk dan tambahkan atribut produk ini';
$_LANG['notice_cost_price'] = 'When the amount of the share is purchased for the customer, the recommender can obtain the base amount through the share.';
$_LANG['on_sale_desc'] = 'Checking means that sales are allowed, otherwise sales are not allowed.';
$_LANG['alone_sale'] = 'Barang dapat dijual secara umum, bukan sebagai hadiah.';
$_LANG['free_shipping'] = 'Produk ini bebas biaya pengiriman';
...
$_LANG['category_manage'] = 'Category';
$_LANG['brand_manage'] = 'Brand';
$_LANG['hide'] = 'Hide';

$_LANG['lab_volume_price']         = 'Harga Berdasarkan Kuantitas:';
$_LANG['volume_number']            = 'Jumlah Produk';
$_LANG['volume_price']             = 'Harga Diskon';
...
$_LANG['goods_article'] = 'Optional articles related to the item';
$_LANG['top_cat'] = 'Top category';
...
$_LANG['js_languages']['goods_cat_not_null'] = 'Kategori Produk Harus Dipilih';
...
$_LANG['js_languages']['button_del'] = 'Hapus';
...
$_LANG['js_languages']['promote_start_not_null'] = 'Promotion start time should not be empt';
