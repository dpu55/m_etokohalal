...
$_LANG['paipai4']['category'] = 'Commodity category';
$_LANG['paipai4']['shopCategoryId'] = 'Store category';
$_LANG['paipai4']['quantity'] = 'Quantity of commodities';
...
$_LANG['paipai4']['description'] = 'Commodity details';
...
$_LANG['ecshop']['goods_name'] = 'Trade name';
$_LANG['ecshop']['goods_sn'] = 'Product code';
$_LANG['ecshop']['brand_name'] = 'Commodity brand';   // 需要转换成brand_id
...
$_LANG['ecshop']['original_img'] = 'Primitive Commodity Map';
$_LANG['ecshop']['goods_img'] = 'Commodity pictures';
$_LANG['ecshop']['goods_thumb'] = 'Commodity thumbnails';
$_LANG['ecshop']['keywords'] = 'Key words of commodities';
$_LANG['ecshop']['goods_brief'] = 'Simple description';
$_LANG['ecshop']['goods_desc'] = 'Detailed description';
$_LANG['ecshop']['goods_weight'] = 'Commodity weight（kg）';
...
$_LANG['ecshop']['is_alone_sale'] = 'Can it be sold as an ordinary commodity?';
$_LANG['ecshop']['is_real'] = 'Is it a physical commodity?';

//自定义导出数据格式
$_LANG['export_custom'] = 'Export to custom data format';
$_LANG['custom']['goods_name'] = 'Trade name';
$_LANG['custom']['goods_sn'] = 'Product code';
$_LANG['custom']['brand_name'] = 'Commodity brand';
...
$_LANG['custom']['original_img'] = 'Primitive Commodity Map';
$_LANG['custom']['goods_img'] = 'Commodity pictures';
$_LANG['custom']['goods_thumb'] = 'Commodity thumbnails';
$_LANG['custom']['keywords'] = 'Key words of commodities';
$_LANG['custom']['goods_brief'] = 'Simple description';
$_LANG['custom']['goods_desc'] = 'Detailed description';
$_LANG['custom']['goods_weight'] = 'Commodity weight（kg）';
...
$_LANG['custom']['is_real'] = 'Is it a physical commodity?';

$_LANG['custom_keyword'] = 'Keyword';
$_LANG['custom_goods_cat'] = 'All categories';
$_LANG['custom_goods_brand'] = 'All brands';
$_LANG['custom_goods_list'] = 'Select commodity data columns';
$_LANG['custom_goods_type'] = 'All commodity types';
$_LANG['custom_export_list'] = 'Output commodity data column';
$_LANG['custom_up'] = 'up';
$_LANG['custom_down'] = 'down';
$_LANG['custom_goods_search'] = 'Derived condition';
$_LANG['custom_goods_field_not_null'] = 'Output commodity data column cannot be empty';

// 导出条件
$_LANG['export_condition'] = 'Batch export of commodity data';
