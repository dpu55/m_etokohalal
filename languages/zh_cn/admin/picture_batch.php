...
$_LANG['do_icon'] = 'Processing product pictures';
$_LANG['all_goods'] = 'Semua produk';
$_LANG['action_notice'] = 'Please select "Handling product photo album" or "Handling commodity picture"';
...
$_LANG['page'] = 'The number of pages';
$_LANG['total'] = 'Page Count';
$_LANG['time'] = 'Processing time';
$_LANG['wait'] = 'Being processed.....';
$_LANG['page_format'] = 'Page %d';
$_LANG['total_format'] = 'Total %d pages';
$_LANG['time_format'] = 'Time-consuming %s seconds';
$_LANG['goods_format'] = 'The total number of product pictures is %d, and each page is processed %d.';
...
$_LANG['error_rename'] = 'Cannot rename file %s to %s';

$_LANG['js_languages']['no_action'] = 'You did not choose any operation.';

$_LANG['silent'] = 'Ignore errors when errors occur and continue to execute the program';
$_LANG['no_silent'] = 'Prompt immediately when an error occurs and terminate the procedure';
