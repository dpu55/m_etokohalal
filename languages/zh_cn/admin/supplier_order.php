...
$_LANG['ss'][SS_SHIPPED_ING] = 'Shipping';
...
$_LANG['product_sn'] = 'Product code';
$_LANG['goods_info'] = 'Product info';
...
$_LANG['from_order_sn'] = 'Order Lainnya:';
$_LANG['to_order_sn'] = 'Order Utama:';
$_LANG['merge'] = 'Gabungkan';
$_LANG['notice_order_sn'] = 'Jika dua order tidak sama informasinya, seperti cara pembayaran, pengiriman, pengemasan, dll, maka akan dipakai informasi dari order utama.';
$_LANG['js_languages']['confirm_merge'] = 'Anda yakin menggabungkan dua pesanan ini?';
...
$_LANG['notice_user'] = '<strong> Note: </strong> Search results only show the first 20 records. If no corresponding members are found, please search more accurately. In addition, if the member is registered from the forum and has not logged on in the mall, and can not be found, you need to login in the mall first.';
...
$_LANG['bos'][0]= "Audit passed </br> </br> Waiting for the user to send back the goods on the way";
$_LANG['bos'][1]= "Receive the goods sent back by the user";
$_LANG['bos'][2]= "Goods returned have been sent";
$_LANG['bos'][3]= "Complete return/repair";
$_LANG['bos'][4]= "refund (no refund)";
$_LANG['bos'][5]= "in the process of application review";
$_LANG['bos'][6]= "application rejected";
$_LANG['bos'][7]= "Delivery of goods overdue, application cancelled automatically";
