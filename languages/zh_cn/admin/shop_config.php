...
$_LANG['cfg_name']['shop_closed'] = 'Toko tutup sementara temporarily';
...
$_LANG['cfg_name']['market_price_rate'] = 'Harga Pasar rate';
...
$_LANG['cfg_name']['shop_keywords'] = 'Kata Kunci';
$_LANG['cfg_name']['shop_country'] = 'Country';
$_LANG['cfg_name']['shop_province'] = 'Provinsi';
$_LANG['cfg_name']['shop_city'] = 'Kota';
$_LANG['cfg_name']['shop_address'] = 'Alamat';
$_LANG['cfg_name']['shop_option'] = 'Position coordinates';
$_LANG['cfg_name']['licensed'] = 'Display Licensed?';
$_LANG['cfg_name']['qq'] = 'Customer Service';
...
$_LANG['cfg_name']['sn_prefix'] = 'Products NO. prefixion';
...
$_LANG['cfg_name']['show_goodsnumber'] = 'Stok';
$_LANG['cfg_name']['show_addtime'] = 'Addtion time';
$_LANG['cfg_name']['show_marketprice'] = 'Menunjukkan Harga Pasar?';
...
$_LANG['cfg_name']['article_title_length'] = 'Judul Artikel length';
...
$_LANG['cfg_name']['search_keywords'] = 'Cari Kata Kunci';
...
$_LANG['cfg_desc']['market_price_rate'] = 'While you enter product price, the system will calculate Harga Pasar by proportion automatically.';
...
$_LANG['cfg_desc']['shop_title'] = 'Judul toko akan tampil di halaman utama toko';
...
$_LANG['cfg_desc']['shop_logo'] = 'Format gambar';
...
$_LANG['cfg_range']['price_format']['1'] = 'If the tail count is not 0, reserve it.';
$_LANG['cfg_range']['price_format']['2'] = 'do not round off, reserve 1 bit decimal.';
$_LANG['cfg_range']['price_format']['3'] = 'do not round off, do not reserve decimal.';
$_LANG['cfg_range']['price_format']['4'] = 'Round off first, reserve 1 bit decimal.';
$_LANG['cfg_range']['price_format']['5'] = 'Round off first, do not reserve decimal.';
...
$_LANG['cfg_desc']['erweima_wapurl'] = 'Input format: http://localhost/mobile/goods.php?Id={id}, note that {id} represents the ID of each commodity, <br>when scanning a two-dimensional code of a commodity with a mobile phone, it will automatically replace the ID of the commodity.';
...
$_LANG['cfg_name']['tag_show_num'] = 'number of commodity labels displayed';
$_LANG['cfg_desc']['tag_show_num'] = 'For example, if you set 5, the label on the commodity details page will display at most 5';
