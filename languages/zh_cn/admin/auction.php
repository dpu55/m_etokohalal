...
$_LANG['auction_log'] = 'Catatan penawaran lelangs';
...
$_LANG['act_name'] = 'Nama Promosi';
$_LANG['goods_name'] = 'Nama Produk';
$_LANG['start_time'] = 'Waktu Mulai';
$_LANG['end_time'] = 'Waktu Berakhir';
$_LANG['deposit'] = 'Bond';
$_LANG['start_price'] = 'Harga Awal';
$_LANG['end_price'] = 'Harga';
$_LANG['amplitude'] = 'Rentang kenaikan harga';
...
/* info */
$_LANG['label_act_name'] = 'Nama Promosi:';
$_LANG['notice_act_name'] = 'Bila tidak diisi, dapat diisi dengan nama produk yang ingin di lelang';
$_LANG['label_act_desc'] = 'Deskripsi produk lelang:';
$_LANG['label_search_goods'] = 'Search for goods based on their number, name, or number';
$_LANG['label_goods_name'] = 'Nama produk yang ingin di lelang:';
$_LANG['label_start_time'] = 'Auction start time:';
$_LANG['label_end_time'] = 'Waktu berakhir lelang:';
$_LANG['label_status'] = 'Status:';
$_LANG['label_start_price'] = 'Harga Awal:';
$_LANG['label_end_price'] = 'Harga:';
$_LANG['label_no_top'] = 'Tidak dibatasi';
$_LANG['label_amplitude'] = 'Rentang kenaikan harga:';
$_LANG['label_deposit'] = 'Bond:';
$_LANG['bid_user_count'] = 'Already existing %s buyer Bid';
$_LANG['settle_frozen_money'] = 'How to deal with the buyers frozen funds?';
$_LANG['unfreeze'] = 'Cairkan deposit';
$_LANG['deduct'] = 'Pengurangan margin';
...
$_LANG['auction_status'][PRE_START] = 'Not begin';
$_LANG['auction_status'][UNDER_WAY] = 'Proceing';
$_LANG['auction_status'][FINISHED] = 'Ended';
$_LANG['auction_status'][SETTLED] = 'Ended';
...
$_LANG['js_languages']['start_price_not_number'] = 'Incorrect starting price (figure)';
...
$_LANG['js_languages']['start_lt_end'] = 'Waktu mulai lelangshould not be greater than the end time';
$_LANG['js_languages']['search_is_null'] = 'No merchandise was found. Please search again.';

/* log */
$_LANG['bid_user'] = 'Pembeli';
$_LANG['bid_price'] = 'Penawaran';
$_LANG['bid_time'] = 'Time';
$_LANG['status'] = 'Status';
