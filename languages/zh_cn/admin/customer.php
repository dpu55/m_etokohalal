...
$_LANG['notice_cus_type'] = 'Customer service represents both pre-sale and after-sale, including both rights. Users can connect to customer service from the front-end commodity page or order page, while pre-sale is only for non-order page, after-sale is only for order page.';
