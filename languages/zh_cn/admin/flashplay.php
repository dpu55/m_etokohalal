<?php
$_LANG['schp_imgsrc'] = 'Rotary Picture Address';
$_LANG['schp_imgurl'] = 'Rotary Picture Links';
$_LANG['schp_imgdesc'] = 'Caption';
...
$_LANG['add_ad'] = 'Custom Added Advertisement';
...
$_LANG['back_custom_set'] = 'Return the custom settings page';
$_LANG['edit_ok'] = 'Successful operation';
$_LANG['edit_no'] = 'operation failed';
$_LANG['id_error'] = 'No rotation pictures specified!';
$_LANG['src_empty'] = 'Please fill in the address of the rotation picture.';
$_LANG['link_empty'] = 'Please fill in the link address.';
$_LANG['go_url'] = 'Rotary Picture List';
$_LANG['ad_play_url'] = 'Advertising Rotation List';
$_LANG['return_edit'] = 'Back';
$_LANG['width_height'] = 'The standard width of the template is: %s and the standard height is: %s.';
$_LANG['invalid_type'] = 'The format of the picture you uploaded is incorrect!';
$_LANG['flash_template'] = 'Available Flash Roadcasting Picture Styles';
...
/* 标签 */
$_LANG['system_set'] = 'System default';
$_LANG['custom_set'] = 'Custom';

/* JS 语言项 */
$_LANG['js_languages']['setupConfirm'] = 'Enabling the new Flash style will override the original style. \n Are you sure you want to enable the selected style?';
?>